#!/usr/bin/env python3
"""
CLI interface for the Clarification Agent conversation.
This provides a simple way to interact with the agent in a terminal.
"""
import os
import sys
import json
...
def print_header():
    """Print the header"""
    print("=" * 80)
    print("🧠 Clarification Agent - Conversation Mode")
    print("=" * 80)
...
def main():
    ...
    while not is_complete:
        ...
        try:
            ...
            if hasattr(agent, 'current_stage_index'):
                agent.current_stage_index += 1
                is_complete = agent.current_stage_index >= len(agent.stages)
